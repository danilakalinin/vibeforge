...
![Окно VibeForge: редактор слева, цветной вывод справа](docs/shots/editor.png)
...
![Диалог сохранения сниппета поверх размытого интерфейса](docs/shots/snippet.png)
...
![Выбор темы в настройках](docs/shots/themes.png)
...
![Выбор AI-провайдера в настройках](docs/shots/ai-providers.png)
